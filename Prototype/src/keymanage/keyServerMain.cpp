...
int main()
{
    ...
    cout << "KeyServerMain : init key server enclave time = " << setprecision(8) << second << " s" << endl;
#endif
    cerr << "KeyServerMain : key server remote attestation done, start to provide service" << endl;
