...
powClient::powClient(Sender* senderObjTemp)
{
    ...
    if (loadSealedDataStatus == true) {
        cout << "PowClient : load sealed information time = " << fixed << setprecision(8) << second << " s" << endl;
    }
#endif
    if (loadSealedDataStatus == true) {
#if SYSTEM_BREAK_DOWN == 1
        ...
        diff = 1000000 * (timeendEnclave.tv_sec - timestartEnclave.tv_sec) + timeendEnclave.tv_usec - timestartEnclave.tv_usec;
        second = diff / 1000000.0;
        cout << "PowClient : sealed init total work time = " << setprecision(8) << second << " s" << endl;
#endif
        if (powEnclaveSealedInitStatus == true) {
            ...
            diff = 1000000 * (timeendEnclave.tv_sec - timestartEnclave.tv_sec) + timeendEnclave.tv_usec - timestartEnclave.tv_usec;
            second = diff / 1000000.0;
            cout << "PowClient : sealed init login ot storage server work time = " << setprecision(8) << second << " s" << endl;
#endif
        ...
        diff = 1000000 * (timeendEnclave.tv_sec - timestartEnclave.tv_sec) + timeendEnclave.tv_usec - timestartEnclave.tv_usec;
        second = diff / 1000000.0;
        cout << "PowClient : remote attestation init login ot storage server work time = " << setprecision(8) << second << " s" << endl;
#endif
        ...
        if (!remoteAttestationStatus) {
            ...
            diff = 1000000 * (timeendEnclave.tv_sec - timestartEnclave.tv_sec) + timeendEnclave.tv_usec - timestartEnclave.tv_usec;
            second = diff / 1000000.0;
            cout << "PowClient : set up remote attestation session key time = " << setprecision(8) << second << " s" << endl;
#endif
            if (status != SGX_SUCCESS) {
...
bool powClient::do_attestation()
{
    ...
    diff = 1000000 * (timeendEnclave.tv_sec - timestartEnclave.tv_sec) + timeendEnclave.tv_usec - timestartEnclave.tv_usec;
    second = diff / 1000000.0;
    cout << "PowClient : remote attestation init enclave time = " << setprecision(8) << second << " s" << endl;
#endif
    if (!msg4->status) {
