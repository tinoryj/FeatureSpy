...
void Configure::readConf(std::string path)
{
    ...
    //FeatureSpy Configure
    _keySeedFeatureNumber = root.get<int>("FeatureSpy._keySeedFeatureNumber");
    _keySeedGenFeatureThreadNumber = root.get<int>("FeatureSpy._keySeedGenFeatureThreadNumber");
}
