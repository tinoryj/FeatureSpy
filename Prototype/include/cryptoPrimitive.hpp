#ifndef FEATURESPY_CRYPTOPRIMITIVE_HPP
#define FEATURESPY_CRYPTOPRIMITIVE_HPP
...
public:
    ...
    bool keyExchangeCTRBaseGenerate(u_char* nonce, uint32_t counter, uint32_t generateBlockNumber, u_char* key, u_char* iv, u_char* ctrBaseBuffer);
...
#endif //FEATURESPY_CRYPTOPRIMITIVE_HPP