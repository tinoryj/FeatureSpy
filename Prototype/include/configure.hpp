#ifndef FEATURESPY_CONFIGURE_HPP
#define FEATURESPY_CONFIGURE_HPP
...
private:
    ...
    // chunking settings
    string _chunkingType; // varSize \ fixedSize \ simple
    ...
    //FeatureSpy settings
    int _keySeedFeatureNumber;
    int _keySeedGenFeatureThreadNumber;
...
public:
    ...
    int getKeySeedFeatureNumber();
    int getKeySeedGenFeatureThreadNumber();
};

#endif //FEATURESPY_CONFIGURE_HPP
